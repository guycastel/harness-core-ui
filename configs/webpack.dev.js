...
const HARNESS_STATIC_FILES_PREFIX = process.env.HARNESS_STATIC_FILES_PREFIX
const DOWNTIME_STATUS_ENDPOINT = process.env.DOWNTIME_STATUS_ENDPOINT
  ...
  plugins: [
    ...
    new HTMLWebpackPlugin({
      ...
      templateParameters: {
        ...
        HARNESS_STATIC_FILES_PREFIX_DEV: HARNESS_STATIC_FILES_PREFIX,
        ...
        DOWNTIME_STATUS_ENDPOINT_DEV: DOWNTIME_STATUS_ENDPOINT
      }
    }),
