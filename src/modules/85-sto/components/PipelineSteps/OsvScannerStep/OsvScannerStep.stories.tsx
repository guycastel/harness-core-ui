...
import { OsvScannerStep as OsvScannerStepComponent } from './OsvScannerStep'

factory.registerStep(new OsvScannerStepComponent())

export default {
  title: 'Pipelines / Pipeline Steps / OsvScannerStep',
...
export const OsvScannerStep: Story<Omit<TestStepWidgetProps, 'factory'>> = args => {
