...
import { transformValuesFieldsConfig, editViewValidateFieldsConfig } from './OsvScannerStepFunctionConfigs'
import type { OsvScannerStepProps, OsvScannerStepData } from './OsvScannerStep'
...
export const OsvScannerStepBase = (
  { initialValues, onUpdate, isNewStep = true, readonly, stepViewType, allowableTypes, onChange }: OsvScannerStepProps,
  formikRef: StepFormikFowardRef<OsvScannerStepData>
): JSX.Element => {
  const {
    state: {
  ...
  const valuesInCorrectFormat = getInitialValuesInCorrectFormat<OsvScannerStepData, OsvScannerStepData>(
    initialValues,
  ...
  return (
    <Formik
      ...
      formName="OsvScannerStep"
      validate={valuesToValidate => {
        const schemaValues = getFormValuesInCorrectFormat<OsvScannerStepData, OsvScannerStepData>(
          valuesToValidate,
      ...
      onSubmit={(_values: OsvScannerStepData) => {
        const schemaValues = getFormValuesInCorrectFormat<OsvScannerStepData, OsvScannerStepData>(
          _values,
        ...
        return (
          <FormikForm>
            ...
            <SecurityScanFields
              ...
              formik={formik}
              scanConfigReadonly
              scanModeSelectItems={[INGESTION_SCAN_MODE, ORCHESTRATION_SCAN_MODE]}
            />
...
export const OsvScannerStepBaseWithRef = React.forwardRef(OsvScannerStepBase)
