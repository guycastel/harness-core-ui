                  ...
                  <>
                    ...
                    >
                      ...
                      <Tab
                        ...
                        title={<Text className={css.tabTitle}>{getString('cf.featureFlags.flagPipeline.title')}</Text>}
                        panel={
                          <FlagPipelineTab flagIdentifier={flagData.identifier} flagVariations={flagData.variations} />
                        }
