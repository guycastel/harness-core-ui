...
function BitbucketFields({ readonly, stepViewType, allowableTypes }: GitProviderFieldProps): React.ReactElement {
  ...
  return (
    <>
      <MultiTypeTextField
        ...
        label={
          <Text tooltipProps={{ dataTooltipId: 'workspace' }} className={css.formLabel} margin={{ bottom: 'medium' }}>
...
export default BitbucketFields
