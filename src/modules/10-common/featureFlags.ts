...
export enum FeatureFlag {
  ...
  SSCA_REPO_ARTIFACT = 'SSCA_REPO_ARTIFACT',
  ...
  FFM_9811_CCM_INTEGRATION = 'FFM_9811_CCM_INTEGRATION',
  ...
  CDS_OVERRIDES_GITX = 'CDS_OVERRIDES_GITX',
  CDS_CONTAINER_STEP_GROUP_AWS_S3_DOWNLOAD = 'CDS_CONTAINER_STEP_GROUP_AWS_S3_DOWNLOAD',
  CDS_NAV_PREFS = 'CDS_NAV_PREFS',
  CDS_HARNESS_DOWNTIME_NOTIFICATION = 'CDS_HARNESS_DOWNTIME_NOTIFICATION',
  CDS_AWS_OIDC_AUTHENTICATION = 'CDS_AWS_OIDC_AUTHENTICATION',
  PL_DISABLE_SM_CREDENTIALS_CHECK = 'PL_DISABLE_SM_CREDENTIALS_CHECK'
}
