...
export interface ActiveDevelopersFilterParams {
  userIdentifier?: string
}

export interface ActiveDevelopersTrendCountDTO {
  count?: number
  date?: string
}
...
export interface IDPActiveDevelopersDTO {
  accountIdentifier?: string
  email: string
  identifier: string
...
export interface IDPLicenseDateUsageParams {
  fromDate?: string
  reportType?: 'DAILY' | 'MONTHLY'
  toDate?: string
}

export interface IDPLicenseUsageDTO {
  accountIdentifier?: string
...
export interface PageIDPActiveDevelopersDTO {
  content?: IDPActiveDevelopersDTO[]
  empty?: boolean
  first?: boolean
  last?: boolean
  number?: number
...
export interface ResponseIDPLicenseUsageDTO {
  correlationId?: string
  data?: IDPLicenseUsageDTO
  metaData?: { [key: string]: any }
  status?: 'SUCCESS' | 'FAILURE' | 'ERROR'
}
...
export interface ResponseListActiveDevelopersTrendCountDTO {
  correlationId?: string
  data?: ActiveDevelopersTrendCountDTO[]
  metaData?: { [key: string]: any }
  status?: 'SUCCESS' | 'FAILURE' | 'ERROR'
}
...
export interface ResponsePageIDPActiveDevelopersDTO {
  correlationId?: string
  data?: PageIDPActiveDevelopersDTO
  metaData?: { [key: string]: any }
  status?: 'SUCCESS' | 'FAILURE' | 'ERROR'
}
...
export type GetIDPHealthStatusProps = Omit<GetProps<RestResponseString, unknown, void, void>, 'path'>

/**
 * get health for IDP service
 */
export const GetIDPHealthStatus = (props: GetIDPHealthStatusProps) => (
  <Get<RestResponseString, unknown, void, void> path={`/health`} base={getConfig('')} {...props} />
)

export type UseGetIDPHealthStatusProps = Omit<UseGetProps<RestResponseString, unknown, void, void>, 'path'>

/**
 * get health for IDP service
 */
export const useGetIDPHealthStatus = (props: UseGetIDPHealthStatusProps) =>
  useGet<RestResponseString, unknown, void, void>(`/health`, { base: getConfig(''), ...props })

export interface GetIDPLicenseUsageQueryParams {
  accountIdentifier?: string
  timestamp?: number
}

export type GetIDPLicenseUsageProps = Omit<
  GetProps<ResponseIDPLicenseUsageDTO, unknown, GetIDPLicenseUsageQueryParams, void>,
  'path'
>

/**
 * Gets License Usage for IDP
 */
export const GetIDPLicenseUsage = (props: GetIDPLicenseUsageProps) => (
  <Get<ResponseIDPLicenseUsageDTO, unknown, GetIDPLicenseUsageQueryParams, void>
    path={`/idp/api/usage/IDP`}
    base={getConfig('')}
    {...props}
  />
)

export type UseGetIDPLicenseUsageProps = Omit<
  UseGetProps<ResponseIDPLicenseUsageDTO, unknown, GetIDPLicenseUsageQueryParams, void>,
  'path'
>
 ...
 * Gets License Usage for IDP
 */
export const useGetIDPLicenseUsage = (props: UseGetIDPLicenseUsageProps) =>
  useGet<ResponseIDPLicenseUsageDTO, unknown, GetIDPLicenseUsageQueryParams, void>(`/idp/api/usage/IDP`, {
    base: getConfig(''),
    ...props
  })

export interface ListIDPActiveDevelopersQueryParams {
  accountIdentifier?: string
  page?: number
  size?: number
  sort?: string[]
...
export type ListIDPActiveDevelopersProps = Omit<
  MutateProps<
    ResponsePageIDPActiveDevelopersDTO,
    unknown,
    ListIDPActiveDevelopersQueryParams,
    ActiveDevelopersFilterParams,
    void
  >,
  'path' | 'verb'
>
...
/**
 * List Active Developers in IDP Module
 */
export const ListIDPActiveDevelopers = (props: ListIDPActiveDevelopersProps) => (
  <Mutate<
    ResponsePageIDPActiveDevelopersDTO,
    unknown,
    ListIDPActiveDevelopersQueryParams,
  ...
  >
    verb="POST"
    path={`/idp/api/usage/IDP/active-developers`}
    base={getConfig('')}
    {...props}
  />
)

export type UseListIDPActiveDevelopersProps = Omit<
  UseMutateProps<
    ResponsePageIDPActiveDevelopersDTO,
    unknown,
    ListIDPActiveDevelopersQueryParams,
 ...
 * List Active Developers in IDP Module
 */
export const useListIDPActiveDevelopers = (props: UseListIDPActiveDevelopersProps) =>
  useMutate<
    ResponsePageIDPActiveDevelopersDTO,
    unknown,
    ListIDPActiveDevelopersQueryParams,
    ActiveDevelopersFilterParams,
    void
  >('POST', `/idp/api/usage/IDP/active-developers`, { base: getConfig(''), ...props })

export interface ListIDPActiveDevelopersHistoryQueryParams {
  accountIdentifier?: string
}

export type ListIDPActiveDevelopersHistoryProps = Omit<
  MutateProps<
    ResponseListActiveDevelopersTrendCountDTO,
    unknown,
    ListIDPActiveDevelopersHistoryQueryParams,
    IDPLicenseDateUsageParams,
    void
  >,
  'path' | 'verb'
>
...
/**
 * List Active Developers history for last 30 days in IDP Module
 */
export const ListIDPActiveDevelopersHistory = (props: ListIDPActiveDevelopersHistoryProps) => (
  <Mutate<
    ResponseListActiveDevelopersTrendCountDTO,
    unknown,
    ListIDPActiveDevelopersHistoryQueryParams,
  ...
  >
    verb="POST"
    path={`/idp/api/usage/IDP/active-developers/history`}
    base={getConfig('')}
    {...props}
  />
)

export type UseListIDPActiveDevelopersHistoryProps = Omit<
  UseMutateProps<
    ResponseListActiveDevelopersTrendCountDTO,
    unknown,
    ListIDPActiveDevelopersHistoryQueryParams,
 ...
 * List Active Developers history for last 30 days in IDP Module
 */
export const useListIDPActiveDevelopersHistory = (props: UseListIDPActiveDevelopersHistoryProps) =>
  useMutate<
    ResponseListActiveDevelopersTrendCountDTO,
    unknown,
    ListIDPActiveDevelopersHistoryQueryParams,
    IDPLicenseDateUsageParams,
    void
  >('POST', `/idp/api/usage/IDP/active-developers/history`, { base: getConfig(''), ...props })
...
export const useLisCDActiveServices = (props: UseLisCDActiveServicesProps) =>
  useMutate<
    ...
    ActiveServicesFilterParams,
    void
  >('POST', `/usage/cd/active-services`, { base: getConfig(''), ...props })
...
export const useGetLicenseUsage = ({ module, ...props }: UseGetLicenseUsageProps) =>
  useGet<ResponseLicenseUsageDTO, Failure | Error, GetLicenseUsageQueryParams, GetLicenseUsagePathParams>(
    ...
    { base: getConfig(''), pathParams: { module }, ...props }
  )
